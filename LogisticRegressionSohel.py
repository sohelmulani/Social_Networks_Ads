...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb  9 19:37:16 2019
...
#deviding datasets into dependant and independant dataset
...
#Applying logistic regression to trainig data
from sklearn.linear_model import LogisticRegression
lr=LogisticRegression(random_state=0)
lr.fit(x_scaled_train,y_train)

#finding probability for x_test data
y_pred=lr.predict(x_scaled_test)

#cheacking no. of accurate predictions using confusion metrics
